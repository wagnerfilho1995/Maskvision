...
class Modelo(models.Model):
    ...
    file_h5 = models.FileField(upload_to='h5files/', null = True, blank=True, verbose_name="Regression Model (.h5)") #Regression Model
    file_txt = models.FileField(upload_to='txtfiles/', null = True, blank=True, verbose_name="Model Information (.txt)") #Model Information
    def __str__(self):
        return self.amplifier.reference
